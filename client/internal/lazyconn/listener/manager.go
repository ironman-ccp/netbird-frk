...
func (m *Manager) CreateFakePeers(peers []wgiface.PeerConfig) error {
...
func (m *Manager) createFakePeer(peerCfg wgiface.PeerConfig) error {
	var (
		listener *Listener
		err      error
		addr     *net.UDPAddr
...
func (m *Manager) createEndpoint(peerCfg wgiface.PeerConfig, endpoint *net.UDPAddr) error {
